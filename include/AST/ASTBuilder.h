...
public:
    ...
    antlrcpp::Any visitSocketType(StaticScriptParser::SocketTypeContext *ctx) override;
    ...
    antlrcpp::Any visitTernaryExpr(StaticScriptParser::TernaryExprContext *ctx) override;
