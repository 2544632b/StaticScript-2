...
public:
    ...
    [[nodiscard]] virtual bool isSocket() const = 0;
...
public:
    ...
    [[nodiscard]] bool isSocket() const override;
...
/// 自定...
class SocketType : public Type {
public: 
    explicit SocketType() = default;

    ~SocketType() override = default;
