...
bool SocketType::isBasic() const {
    return false;
}

bool SocketType::isBoolean() const {
    return false;
}

bool SocketType::isInteger() const {
    return false;
}

bool SocketType::isFloat() const {
    return false;
}

bool SocketType::isNumber() const {
    return false;
}

bool SocketType::isString() const {
    return false;
}

bool SocketType::isUnknown() const {
    return false;
}

bool SocketType::isArray() const {
    return false;
}

bool SocketType::isNumberArray() const {
    return false;
}

bool SocketType::isSocket() const {
    return true;
}

SharedPtr<ArrayType> SocketType::asArray() const {
    return nullptr;
}
